...
struct ContentView: View {
    var body: some View {
        ZStack {
            LinearGradient(colors: [.cyan.opacity(0.7),.purple.opacity(0.7)], startPoint: .topLeading, endPoint: .bottomTrailing)
            ...
            VStack(spacing: 50) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    ...
                    HStack(alignment: .top) {
                        Text("yeah I tried to go yesterday but they were closed so maybe tomorrow ")
                            .font(.caption)

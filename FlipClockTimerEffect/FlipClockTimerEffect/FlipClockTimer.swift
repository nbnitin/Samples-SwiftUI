...
struct FlipClockTimerView: View {
    ...
    var animatioDuration : CGFloat = 0.8
    ...
    var body: some View {
        ...
        .onChange(of: value, initial: true) { oldValue, newValue in
            ...
            guard oldValue != nextValue else {
                return
            }
            
            withAnimation(.easeInOut(duration: animatioDuration), completionCriteria: .logicallyComplete, {
                rotation = -180
            }, completion: {
                rotation = 0
                currentValue = value
